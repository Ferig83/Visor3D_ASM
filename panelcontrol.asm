...
ANGULO_FOV	 equ 0x3f490fdb   ; Ojo! que el angulo es pi/4. Luego divido por dos en la función, resultando en pi/8
ZFAR 	 	 equ 0x447a0000   ; 1000
ZNEAR 		 equ 0x3dcccccd	  ; 0.1 
